...
\item pokud je v cestě protihráčova figurka, tah je povolen (případné vzatí figurky se bude řešit v metodě \char`\"{}make\+\_\+move\char`\"{} třídy {\ttfamily player})
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item tato metoda se volá v {\ttfamily Human\+Player\+::make\+\_\+move} a {\ttfamily AIPlayer\+::make\+\_\+move}
\end{DoxyItemize}
...
\item má polymorfní metodu {\ttfamily make\+\_\+move}, která si vyžadá\+: {\ttfamily aktuální šachovnice}, {\ttfamily startovní\+\_\+pozice}, {\ttfamily cílová\+\_\+pozice} a vrátí {\ttfamily true}, pokud je tah platný, v opačném případě vrátí {\ttfamily false}
\begin{DoxyItemize}
